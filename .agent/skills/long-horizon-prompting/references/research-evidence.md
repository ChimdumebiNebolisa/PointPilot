...
- October 2025: a claim that GPT-5 solved ten ErdÅ‘s problems collapsed within about 48 hours because the "solutions" were already in the literature.
- May 2026: an OpenAI internal reasoning model disproved the ErdÅ‘s unit-distance conjecture; the result stands because nine external mathematicians verified it and a companion paper followed. The prompt was reportedly minimal: the problem statement plus the question of whether ErdÅ‘s was wrong.
...
| Non-counting outcomes | ErdÅ‘s/CDC record: near misses and unverified claims dominate failures |
